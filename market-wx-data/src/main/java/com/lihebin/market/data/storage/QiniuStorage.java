 ...
 * @date: 2021/3/31 9:27 下午
 */
@Slf4j
@Service
public class QiniuStorage implements Storage{

    @Value("${market.storage.qiniu.endpoint}")
    private String endpoint;

    @Value("${market.storage.qiniu.accessKey}")
    private String accessKey;

    @Value("${market.storage.qiniu.secretKey}")
    private String secretKey;

    @Value("${market.storage.qiniu.bucketName}")
