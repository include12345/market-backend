package com.lihebin.market.data.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.lihebin.market.data.dao"}
)
public class MarketJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryMarket(EntityManagerFactoryBuilder builder) {
        return builder
                .dataSource(marketDataSource).packages("com.lihebin.market.data.model")//设置实体类所在位置
