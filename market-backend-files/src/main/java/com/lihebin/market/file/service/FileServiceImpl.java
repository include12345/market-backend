...
public class FileServiceImpl implements FileService{
    ...
    public String uploadPicture(MultipartFile file) {
        ...
        if (!CODE_OK.equalsIgnoreCase(code)) {
            ...
            throw new BackendException(Code.CODE_NOT_EXIST, "上传文件失败");
        }
        ...
        if (null == tempFile) {
            ...
            throw new BackendException(Code.CODE_NOT_EXIST, "转换文件失败");
        }
        ...
        return String.format("%s/api/alien/download/%s/%s", pictureUrl, uuid, name);
    }
